...
import com.cove.safetyplan.config.PropertiesConfig;
...
@Component
public class CoveException {
    private static PropertiesConfig propertiesConfig;

    @Autowired
    public CoveException(PropertiesConfig propertiesConfig) {
        CoveException.propertiesConfig = propertiesConfig;
    }
